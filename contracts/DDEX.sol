 ...
 * https://etherscan.io/address/0xe2a0bfe759e2a4444442da5064ec549616fff101
...
contract LibDiscount is LibOwnable {
     ...
     */
    function getHotBalance(address owner) internal returns (uint256 result) {
     ...
     */
    function getDiscountedRate(address user) public returns (uint256 result) {
